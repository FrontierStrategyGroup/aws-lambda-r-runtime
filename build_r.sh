...
./bin/Rscript -e 'chooseCRANmirror(graphics=FALSE, ind=34); install.packages("forecast")'
./bin/Rscript -e 'chooseCRANmirror(graphics=FALSE, ind=34); install.packages("tseries")'
